...
var register_enroll_user = require('./register_enroll_user.js');
var logger = register_enroll_user.getLogger('invoke-chaincode');
...
var invokeChaincode = async function (peerNames, channelName, chaincodeName, fcn, args, username, org_name) {
	...
	try {
		...
		var client = await register_enroll_user.getClientForOrg(org_name, username);
        ...
        console.log("Get proposal-> ", results)
		...
		if (all_good) {
            ...
            console.log("Send transaction-> ", sendPromise)

...
import (
	"encoding/json"
	"fmt"
	"github.com/Hnampk/fabric-flogging"
...
// Restricted method that checks for a specific attribute
func (s *SmartContract) RestrictedMethod(ctx contractapi.TransactionContextInterface) error {
	// Get the client's identity
	clientIdentity := ctx.GetClientIdentity()

	// Check if the client has the 'role' attribute and if it is 'admin'
	...
	// Access granted, perform your logic here
